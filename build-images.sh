...
docker build -t kudu-base --platform amd64 kudu-base/
docker build -t kudu-master --platform amd64 kudu-master/
docker build -t kudu-tserver --platform amd64 kudu-tserver/
